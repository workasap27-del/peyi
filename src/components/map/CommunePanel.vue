...
// Tous les sondages globaux actifs (commune_id IS NULL), hors baromètres permanents
...
const color = computed(() =>
  props.commune ? participationColor(props.commune.participantCount, communesStore.maxCount) : '#6b7280'
)
...
<template>
  <Transition name="panel">
    ...
    >
      ...
      <!-- Sondages ouverts à tous -->
      <div class="px-5 pt-4 pb-8">
        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">
          Sondages ouverts à tous les Guadeloupéens
        </p>
        ...
        <p v-else class="text-sm text-gray-400 italic py-3">
          Aucun sondage global en cours — revenez bientôt
        </p>
      </div>
    </div>
  </Transition>
